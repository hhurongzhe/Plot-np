...
plt.plot(
    ...
    zorder=1)
plt.scatter(
    partial_wave_data['1H5'][0],
    partial_wave_data['1H5'][1],
    facecolors='none',
    edgecolors=marker_c,
    s=marker_s,
    alpha=marker_a,
...
plt.ylim(-1.6, 0)  # set y-axis limits
...
plt.yticks([-1.6, -0.8, 0], ['-1.6', '-0.8', '0'],
           fontfamily=font_family, fontweight=font_weight, fontsize=font_size)
...
plt.plot(
    ...
    zorder=1)
plt.scatter(
    partial_wave_data['3H4'][0],
    partial_wave_data['3H4'][1],
    c=marker_c,
    s=marker_s,
    alpha=marker_a,
    zorder=2)
...
plt.plot(
    ...
    zorder=1)
plt.scatter(
    partial_wave_data['3H5'][0],
    partial_wave_data['3H5'][1],
    facecolors='none',
    edgecolors=marker_c,
    s=marker_s,
    alpha=marker_a,
...
plt.xticks([0, 100, 200, 300, 400], ['0', '100', '200', '300', '400'],
           fontfamily=font_family, fontweight=font_weight, fontsize=font_size)
plt.yticks([-1.2, -0.6, 0], ['-1.2', '-0.6', '0'],
           fontfamily=font_family, fontweight=font_weight, fontsize=font_size)
plt.tick_params(direction='in', width=width_ticks, length=length_ticks)
tk = plt.gca()
tk.spines['bottom'].set_linewidth(width_frame)
...
plt.plot(
    ...
    zorder=1)
plt.scatter(
    partial_wave_data['3H6'][0],
    partial_wave_data['3H6'][1],
    facecolors='none',
    edgecolors=marker_c,
    s=marker_s,
    alpha=marker_a,
...
plt.xticks([0, 100, 200, 300, 400], ['0', '100', '200', '300', '400'],
           fontfamily=font_family, fontweight=font_weight, fontsize=font_size)
plt.yticks([0, 0.3, 0.6], ['0', '0.3', '0.6'],
           fontfamily=font_family, fontweight=font_weight, fontsize=font_size)
plt.tick_params(direction='in', width=width_ticks, length=length_ticks)
tk = plt.gca()
tk.spines['bottom'].set_linewidth(width_frame)
...
plt.savefig('phase-H.png', bbox_inches='tight', dpi=600)
plt.show()